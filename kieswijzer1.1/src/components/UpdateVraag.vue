    ...
    <div class="table-responsive">
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            <div class="col-sm-10"><h2>Update <b>dashboard</b></h2></div>
          </div>
        </div>
        <table class="table table-striped table-hover table-bordered">
          ...
          <tr v-for="(vraag, index) in vragenData" :key="index">
            <td>{{ vraag.id }}</td>
            <td><div contenteditable >{{ vraag.vraag }}</div></td>
            ...
            <td><a href="#" v-on:click="updateVraag(vraag.id)" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a></td>
          </tr>
          </tbody>
        </table>
      </div>
